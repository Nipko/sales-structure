...
- API: https://api.parallly-chat.cloud (NestJS, 40 modules)
...
| **40 modules table + key files for common tasks (~80 entries) + dashboard pages (60+) + cron jobs** | `docs/modules-reference.md` |

...
At the end, click **Finish setup**. If you'd rather explore on your own, the **Skip for now** button closes the wizard (you can configure everything later from the menu).
...
When you click **Finish setup**, the dashboard shows a short **guided tour** highlighting the essentials:

...
- Restaurants can see **Menu** and **Food orders** by subtype. Automotive uses **Vehicles**; its rental subtype can use **Resource rentals**.
- Education uses **Courses** and appointments. Retail and Other can use inventory and orders. Finance, professional services, and technology use appointments when their capability enables them.

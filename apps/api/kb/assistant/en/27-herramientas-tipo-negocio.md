...
A vertical groups businesses; the business type defines their actual operations. A hotel and a tour agency both belong to tourism, but need different catalogues, availability and booking records. Set the account's actual business type before selecting tools.
...
3. Complete each tool's records in its module: products, menu, services, capacity, courses or other business data. Some businesses use **Service catalogue** without a time-slot calendar.

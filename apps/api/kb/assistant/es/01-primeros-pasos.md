...
Sin un canal conectado, el negocio **no recibe mensajes por ese medio**. Al conectar el primer canal, tu agente predeterminado queda asignado a él y empieza a responder ahí tal como lo probaste en el chat; no hay que volver al editor. Te recomendamos empezar por **WhatsApp**, el canal más usado en Latinoamérica: arranca con una sola pregunta —¿dónde vive hoy tu número?— para que elijas el camino correcto desde el principio. Mientras tanto, tu agente ya responde en el enlace de tu agente, aunque esa página no cuenta como canal conectado.
...
En **Canales** verás qué conexiones puedes activar; **Plan y facturación** muestra la disponibilidad y los límites aplicables a tu cuenta.
...
Es una página pública que existe desde el día 0, antes de conectar cualquier canal, donde cualquiera puede chatear con tu agente igual que un cliente. La plataforma paga sus primeros mensajes hasta un cupo por cuenta y cada página tiene un tope de mensajes por día; al llegar al límite el propio chat lo dice y sigue al día siguiente o cuando actives tu plan. No cuenta como canal conectado: la tarjeta **Puesta en marcha** sigue pidiendo un canal real (WhatsApp, Instagram, Messenger, Telegram o el chat web de tu sitio).

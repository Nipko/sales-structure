...
keywords: ["problemas", "no funciona", "no llegan mensajes", "no responde", "el bot no responde", "canal desconectado", "token expirado", "reconectar", "campaña no envia", "plantilla rechazada", "limite del plan", "limite alcanzado", "cita no aparece", "calendario no sincroniza", "correo de verificacion", "no llega el codigo", "error", "ayuda", "soporte", "contactar soporte", "envio pausado", "meta no puede cobrar", "el agente dejo de responder en whatsapp", "medio de pago de whatsapp", "reanudar envios", "zona horaria de facturacion", "whatsapp no entrega", "canal que nadie responde"]
---
...
1. **¿La conexión tiene agente asignado?** Entra a **Agente IA**. Si ves un aviso tipo "canales sin agente asignado", esas conexiones las atiende tu agente predeterminado, si está activo. Si no hay uno activo, o si dos agentes tienen asignada la misma conexión, ahí no contesta nadie: **Salud de agentes** lo marca como crítico en **Cada canal conectado tiene un agente que responde**. Abre el agente correcto y, en **Asignación de conexiones**, marca la cuenta exacta que debe atender. Recuerda: hay **un agente de IA por conexión**.
...
4. **¿La conversación quedó con una persona?** Cuando el agente pasa una conversación a tu equipo, la IA queda en pausa en esa conversación mientras la atiende una persona; resuélvela en el **Inbox** cuando termines. Revisa también en **Agentes IA** que el agente esté encendido.
...
7. **¿Es WhatsApp y algo frena todas las respuestas de ese número?** **Salud de agentes** lo muestra en el control **WhatsApp puede entregar las respuestas**, con el motivo: falta confirmar la **zona horaria de facturación** del número; Meta no acepta cobros de tu cuenta de WhatsApp; la cuenta no tiene método de pago en Meta (desde el **1 de octubre de 2026** Meta cobra a tu cuenta de WhatsApp Business cada mensaje de servicio entregado y, sin método de pago, deja de entregar); o, con la **Protección de gasto** activa, todavía no se sabe en qué moneda cobra Meta. **Si eres administrador**, entra a **Canales → WhatsApp**: confirma ahí la zona horaria del número, agrega o arregla el medio de pago en las herramientas de Meta y, si la tarjeta **Cobro de WhatsApp (Meta)** dice **Envío pausado**, toca **Reanudar envíos**. **Si eres supervisor o agente**, esa pantalla no se te abre: el síntoma se reconoce desde el **Inbox** —WhatsApp deja de salir mientras Instagram, Messenger o Telegram siguen contestando—, y un supervisor también lo ve en **Salud de agentes**. Lo que te toca es avisarle al administrador, porque la zona horaria, el medio de pago y reanudar los envíos son suyos. Los mensajes que entran se siguen recibiendo mientras tanto.

...
La facturation du compte se trouve dans **Administration → Forfait et facturation**. Seul un administrateur peut y accéder. La page affiche les valeurs et actions activées pour ce compte et ce pays ; utilisez-la comme source actuelle plutôt qu'un tableau, une capture ou un document externe.

## Ce que vous pouvez consulter

Selon la configuration du compte, la page peut afficher :

- le forfait actuel, ses fonctions, l'utilisation et la capacité disponible ;
...
## Changer de forfait, de cycle ou de moyen de paiement

Lorsque l'action est activée, ouvrez **Forfait et facturation**, choisissez l'option disponible et relisez le récapitulatif avant de confirmer. Celui-ci doit indiquer le montant, la devise, la date d'effet, l'impact sur la capacité et les conditions de renouvellement ou d'annulation. Ne promettez pas un changement immédiat ni une carte particulière : l'écran de confirmation du compte fait foi.

Saisissez les données de paiement uniquement dans le parcours sécurisé ouvert par Parallly. Le prestataire et les moyens acceptés dépendent de l'intégration active. Si un débit échoue, suivez l'état et les actions visibles ; si aucune nouvelle tentative ou mise à jour n'est proposée, contactez le support avec la date approximative et le message d'erreur, sans transmettre de numéros complets ni de codes de sécurité.
...
Uniquement lorsque l'action est activée. Lisez le récapitulatif de confirmation pour connaître sa date d'effet et les conséquences sur l'accès.

...
1. **La connexion a-t-elle un agent assigné ?** Ouvrez **Agent IA**. Si vous voyez un avertissement du type « canaux sans agent assigné », ces connexions sont prises en charge par votre agent par défaut, s'il est actif. S'il n'y en a pas d'actif, ou si deux agents ont la même connexion affectée, personne n'y répond : **Santé des agents** le signale comme critique dans **Chaque canal connecté a un agent qui répond**. Ouvrez le bon agent et, dans **Affectation des connexions**, cochez le compte exact qui doit les prendre en charge. Rappel : il y a **un agent IA par connexion**.
...
4. **La conversation est-elle restée avec une personne ?** Quand l'agent transmet une conversation à votre équipe, l'IA se met en pause dans cette conversation pendant qu'une personne s'en occupe ; résolvez-la dans la **Boîte de réception** quand vous avez terminé. Vérifiez aussi dans **Agents IA** que l'agent est activé.
...
7. **S'agit-il de WhatsApp, avec quelque chose qui bloque toutes les réponses de ce numéro ?** **Santé des agents** l'affiche dans le contrôle **WhatsApp peut livrer les réponses**, avec la raison : le **fuseau horaire de facturation** du numéro reste à confirmer ; Meta refuse de facturer votre compte WhatsApp ; le compte n'a pas de moyen de paiement chez Meta (à partir du **1er octobre 2026**, Meta facture à votre compte WhatsApp Business chaque message de service livré et, sans moyen de paiement, cesse de livrer) ; ou, avec la **Protection des dépenses** active, on ne sait pas encore dans quelle devise Meta facture. **Si vous êtes administrateur**, ouvrez **Canaux → WhatsApp** : confirmez-y le fuseau horaire du numéro, ajoutez ou corrigez le moyen de paiement dans les outils de Meta et, si la carte **Facturation WhatsApp (Meta)** indique **Envoi en pause**, appuyez sur **Reprendre les envois**. **Si vous êtes superviseur ou agent**, cet écran ne s'ouvre pas pour vous : le symptôme se reconnaît depuis la **Boîte de réception** — WhatsApp cesse de sortir alors qu'Instagram, Messenger ou Telegram continuent de répondre —, et un superviseur le voit aussi dans **Santé des agents**. Votre rôle est de prévenir l'administrateur, car le fuseau horaire, le moyen de paiement et la reprise des envois lui reviennent. Les messages entrants continuent d'être reçus entre-temps.

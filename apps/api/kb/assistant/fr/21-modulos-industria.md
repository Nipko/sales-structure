...
- Les restaurants peuvent voir **Menu** et **Commandes** selon le sous-type. L'automobile utilise **Véhicules** ; le sous-type location peut utiliser **Location de ressources**.
- L'éducation utilise **Cours** et rendez-vous. Le commerce de détail et Autre peuvent utiliser stock et ordres. Finance, services professionnels et technologie utilisent les rendez-vous lorsque leur capacité le permet.
...
Si vous avez choisi **Autre** parce que votre activité n'entre dans aucun secteur, la plateforme rédige votre recette à partir de la description donnée à l'inscription. Elle est générée en arrière-plan et apparaît à votre prochaine visite. Si cette description change, la recette est réécrite. Elle ne remplace jamais ce que vous avez modifié vous-même.

...
A mudança vale mensagem a mensagem: assim que o seu plano inclui o chat web, a próxima mensagem que chega pelo link já é atendida como canal de verdade, sem reconectar nada. Em **Administração → Canais** o link tem uma linha própria, com a etiqueta **Nada para conectar** e os botões **Abrir** e **Copiar link**: não se conecta nem se desconecta, e para o cartão **Primeiros passos** não conta como canal conectado.

...
No final, clique em **Finalizar configuração**. Se preferir explorar por conta própria, o botão **Pular por enquanto** fecha o assistente (você pode configurar tudo depois pelo menu).
...
Ao clicar em **Finalizar configuração**, o painel mostra um breve **tour guiado** apontando o essencial:

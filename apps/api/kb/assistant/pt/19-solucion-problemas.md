...
Confira esta lista na ordem; quase sempre a causa é uma destas. Antes, um aviso sobre permissões: **Agente IA**, **Canais** e **Plano e faturamento** são telas de administração: se você é supervisor ou agente, não consegue abri-las — não estão no seu menu e, se digitar o endereço, o painel redireciona você —, então esses passos são do administrador da conta, e o seu papel é reconhecer o sintoma pela **Caixa de entrada** e avisá-lo. **Campanhas** é diferente: o administrador e o supervisor abrem, o agente não. E o supervisor não fica sem o que olhar: **Saúde dos agentes** está no menu dele, e ali dá para ver se o agente vem respondendo pior que o normal antes de pedir que alguém abra uma tela de administração.

1. **A conexão tem um agente atribuído?** Acesse **Agente IA**. Se você vir um aviso do tipo "canais sem agente atribuído", essas conexões são atendidas pelo seu agente padrão, se estiver ativo. Se não houver um ativo, ou se dois agentes tiverem a mesma conexão atribuída, ninguém responde ali: a **Saúde dos agentes** marca isso como crítico em **Cada canal conectado tem um agente que responde**. Abra o agente correto e, em **Atribuição de conexões**, marque a conta exata que ele deve atender. Lembre-se: há **um agente de IA por conexão**.
...
4. **A conversa ficou com uma pessoa?** Quando o agente passa uma conversa para a sua equipe, a IA fica em pausa nessa conversa enquanto uma pessoa a atende; resolva-a na **Caixa de entrada** quando terminar. Confira também em **Agentes de IA** se o agente está ligado.
...
7. **É o WhatsApp e algo está barrando todas as respostas daquele número?** A **Saúde dos agentes** mostra isso no controle **O WhatsApp consegue entregar as respostas**, com o motivo: falta confirmar o **fuso horário de cobrança** do número; a Meta não aceita cobranças da sua conta do WhatsApp; a conta não tem meio de pagamento na Meta (a partir de **1º de outubro de 2026** a Meta cobra da sua conta do WhatsApp Business cada mensagem de serviço entregue e, sem meio de pagamento, deixa de entregar); ou, com a **Proteção de gastos** ativa, ainda não se sabe em que moeda a Meta cobra. **Se você é administrador**, abra **Canais → WhatsApp**: confirme ali o fuso horário do número, adicione ou corrija a forma de pagamento nas ferramentas da Meta e, se o cartão **Cobrança do WhatsApp (Meta)** disser **Envio pausado**, toque em **Retomar envios**. **Se você é supervisor ou agente**, essa tela não abre para você: o sintoma se reconhece pela **Caixa de entrada** — o WhatsApp para de sair enquanto Instagram, Messenger ou Telegram seguem respondendo —, e um supervisor também o vê na **Saúde dos agentes**. O seu papel é avisar o administrador, porque o fuso horário, a forma de pagamento e retomar os envios são dele. As mensagens que chegam continuam sendo recebidas enquanto isso.

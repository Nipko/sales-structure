...
export class ComplianceController {
    ...
    async getLegalTexts(@Param('tenantId') tenantId: string) {
        return this.complianceService.getLegalTexts(this.schemaFor(tenantId));
    }
    ...
    async createLegalText(@Param('tenantId') tenantId: string, @Body() payload: any) {
        return this.complianceService.createLegalText(this.schemaFor(tenantId), { ...payload, tenant_id: tenantId });
    }
    ...
    async getConsents(@Param('tenantId') tenantId: string, @Query('leadId') leadId?: string) {
        return this.complianceService.getConsents(this.schemaFor(tenantId), leadId);
    }
    ...
    async createConsent(@Param('tenantId') tenantId: string, @Body() payload: any) {
        return this.complianceService.createConsent(this.schemaFor(tenantId), { ...payload, tenant_id: tenantId });
    }
    ...
    async getOptOuts(@Param('tenantId') tenantId: string) {
        return this.complianceService.getOptOuts(this.schemaFor(tenantId));
    }
    ...
    async createOptOut(@Param('tenantId') tenantId: string, @Body() payload: any) {
        return this.complianceService.createOptOut(this.schemaFor(tenantId), { ...payload, tenant_id: tenantId });
    }
    ...
    async getDeletionRequests(@Param('tenantId') tenantId: string) {
        return this.complianceService.getDeletionRequests(this.schemaFor(tenantId));
    }
    ...
    async createDeletionRequest(@Param('tenantId') tenantId: string, @Body() payload: any) {
        return this.complianceService.createDeletionRequest(this.schemaFor(tenantId), { ...payload, tenant_id: tenantId });
    }
    ...
    async processDeletionRequest(@Param('tenantId') tenantId: string, @Param('id') id: string) {
        return this.complianceService.processDeletionRequest(this.schemaFor(tenantId), id);
    }
}

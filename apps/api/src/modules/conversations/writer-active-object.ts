...
export const WRITER_ACTIVE_OBJECTS: Readonly<Record<string, WriterObjectDefinition>> = Object.freeze({
    ...
    cancel_vehicle_rental: object('vehicle_rental', ['rentalId', 'rental.id', 'id'], ['rentalId']),
    create_repair_order: object('repair_order', ['repairOrderId', 'repairOrder.id', 'id']),
    approve_repair: object('repair_order', ['repairOrderId', 'id'], ['repairOrderId']),
    cancel_repair_order: object('repair_order', ['repairOrderId', 'id'], ['repairOrderId']),
    create_pet_boarding: object('pet_boarding', ['boardingId', 'boarding.id', 'rentalId', 'rental.id', 'id']),
    cancel_pet_boarding: object('pet_boarding', ['boardingId', 'rentalId', 'rental.id', 'id'], ['boardingId']),

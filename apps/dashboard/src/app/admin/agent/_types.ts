export interface PersonaConfig {
  ...
  tools?: {
    ...
    tours?: { enabled: boolean; emailConfirmations?: boolean };
    treatments?: { enabled: boolean; emailConfirmations?: boolean };
    realEstate?: { enabled: boolean; emailConfirmations?: boolean };
    pets?: { enabled: boolean; emailConfirmations?: boolean };
    restaurants?: { enabled: boolean; emailConfirmations?: boolean };
    gyms?: { enabled: boolean; emailConfirmations?: boolean };

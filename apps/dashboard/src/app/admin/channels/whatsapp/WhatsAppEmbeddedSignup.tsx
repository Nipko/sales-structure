  ...
  return (
    <div className="relative">
      <button
        ...
        className={`w-full py-3.5 px-6 rounded-xl border-none text-white font-bold text-[15px] flex items-center justify-center gap-2.5 shadow-[0_4px_14px_rgba(37,211,102,0.3)] transition-all ${
          processing
            ? "bg-gradient-to-br from-[#1a8d48] to-[#128C7E]"
            : "bg-gradient-to-br from-[#25D366] to-[#128C7E]"
        } ${!sdkLoaded ? "opacity-50 cursor-not-allowed" : sdkLoaded && !launching && !processing ? "cursor-pointer" : "cursor-not-allowed"}`}
      >
      ...
      <button
        ...
        disabled={processing}
        className={`w-full mt-2.5 py-2.5 px-5 rounded-[10px] border border-border bg-transparent text-foreground font-semibold text-[13px] cursor-pointer flex items-center justify-center gap-2 ${
      ...
      <p className="mt-2.5 text-xs text-[var(--text-secondary)] text-center leading-relaxed">
        {t("securityNote")}
      </p>
    </div>
  );

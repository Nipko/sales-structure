...
function PhotosTab({
  ...
  // Resync when the property reloads.
  useEffect(() => {
    setImages(property.images || []);
  }, [property.id, JSON.stringify(property.images)]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  return (
    <div className="max-w-4xl space-y-5">
      <PhotoManager
        ...
        onChange={setImages}
        persist={async (next) => {
          const res = await api.updateProperty(tenantId, property.id, { images: next });

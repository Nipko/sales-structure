                    ...
                    <img src={thumbUrl} alt={file.label || file.originalName}
                      ...
                      onError={e => {
                        ...
                        if (!img.dataset.retried) {
                          ...
                          img.src = "data:image/svg+xml," + encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' width='100' height='100'><rect width='100' height='100' fill='#f0f0f0'/><text x='50' y='55' text-anchor='middle' fill='#999' font-size='11'>${t('imageUnavailable')}</text></svg>`);
                        }
                      }} />
                    {!isEditing && (

...
## Addendum — 16 de septiembre de 2026

Este plan se desplegó el 4-sep (`4f2390e4`). Entre el 6 y el 14 de septiembre, ocho commits posteriores (`d50d1670`, `751d23e7`, `b5b71b60`, `cb9088cb`, `6f02b278`, `a7337a10`, `4c6516a5`/`64e6e936`, `5deee1bd`) montaron encima del asistente y del editor los paneles de versión/borrador, misión y evaluación, y llevaron la tarjeta de puesta en marcha de 6 esenciales a 8-10. Un video real del 14-sep muestra el resultado: 41 minutos de pantalla, cero respuestas del agente, WhatsApp sin conectar y 15 minutos de edición perdidos en silencio. El estado real de cada principio (P1-P9) y de cada unidad de la Parte II, con la evidencia, está en `docs/onboarding-diagnosis-2026-09.md` (§3.2 para la regresión, Apéndice A para la tabla). Ese documento reemplaza a esta Parte II como diagnóstico vigente; esta Parte sigue siendo válida como registro de lo que se construyó.

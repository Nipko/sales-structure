...
Revisión: `8d3cddc1dad790ab14bc776c998b8e7c05167041`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 32 call sites, 29 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 66 productores y 21 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| De ellos, con alguna propiedad en `none` | 21 |

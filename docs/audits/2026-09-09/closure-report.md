...
Revisión: `b31f2a875298717dff409523f8d5beecef9bb58b`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 31 call sites, 27 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 65 productores y 46 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |

...
Revisión: `66c7edfee01293f903dfcccbc0a95395e2d4bad7`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 32 call sites, 29 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 66 productores y 23 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| De ellos, con alguna propiedad en `none` | 23 |

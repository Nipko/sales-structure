...
Revisión: `c1f25f1ad562dcea4cfff6d44374d125d3cab6b5`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 25 call sites, 21 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 63 productores y 40 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| De ellos, con alguna propiedad en `none` | 40 |

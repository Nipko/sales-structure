...
Revisión: `bd7dbb7d13d9f65e316d10f7927ee6f048c21576`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 32 call sites, 29 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 68 productores y 17 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| Productores declarados en el inventario de efectos | 68 |
| De ellos, con alguna propiedad en `none` | 17 |

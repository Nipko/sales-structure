...
Revisión: `5deee1bd5f6e107c3fe48f387c93f64c32602fc1`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 31 call sites, 27 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 62 productores y 43 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |

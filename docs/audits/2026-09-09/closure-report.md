...
Revisión: `09c4bf3fb4898315c6edbd342a3e5282706bd3cf`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 25 call sites, 21 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 63 productores y 39 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| De ellos, con alguna propiedad en `none` | 39 |

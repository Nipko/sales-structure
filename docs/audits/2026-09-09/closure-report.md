...
Revisión: `32b1232e8837b8663abb55abaf3a658ea11196e7`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 29 call sites, 25 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 63 productores y 35 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| R0 | **aceptada** | contador | — | De 25 call sites cobrables, 0 usan un carril que no escribe fila antes del POST — Redis es el registro, o no hay registro. Un productor ahí no puede contestar "¿esto salió?" después de un reinicio. **Este número no es el criterio de R6**, que pregunta por la autorización aplicable y la mide con los productores fuera del gate económico. Lo que esta fila mide es la fila durable antes del POST; desde este HEAD todo productor cobrable la crea y ningún interruptor puede devolverlo al carril anterior. | — |
...
| Call sites de egress censados | 29 |
| De ellos, cobrables | 25 |
...
| De ellos, con alguna propiedad en `none` | 35 |

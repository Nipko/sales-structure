...
Revisión: `1a6fec0d573ff91bec82667f1958c72074d1904b`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 29 call sites, 25 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 63 productores y 36 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| De ellos, con alguna propiedad en `none` | 36 |

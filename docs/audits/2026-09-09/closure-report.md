...
Revisión: `d76cfd8f02e89c9ab73939a6ad2bef724bb73441`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 32 call sites, 29 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 66 productores y 24 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| De ellos, con alguna propiedad en `none` | 24 |

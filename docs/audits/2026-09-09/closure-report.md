...
Revisión: `a00ff61708ce036fc874cafc209401909156d056`.
...
| M0 | **aceptada** | contador | — | Censo derivado del árbol: 28 call sites, 25 cobrables, 0 fuera de la autoridad económica. El inventario de efectos declara 65 productores y 34 con al menos una propiedad en `none`. La condición es que el artefacto versionado se regenere desde el mismo HEAD, no que alguien lo haya leído. | — |
...
| Call sites de egress censados | 28 |
...
| De ellos, con alguna propiedad en `none` | 34 |

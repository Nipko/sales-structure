...
| `modules/conversations/conversations.service.ts:6072` | `sendCollectedFlow` | `outbound_queue` |
...
| `modules/conversations/conversations.service.ts:6072` | `sendCollectedFlow` | `outbound_queue` | dynamic | 1 (read) |

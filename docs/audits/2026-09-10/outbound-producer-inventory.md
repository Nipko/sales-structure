...
| Línea | Método | Primitiva | Carril | Disparador | Canales | Efectos por respuesta | Base |
|---:|---|---|---|---|---|---|---|
| 328 | `handleSendTemplate` | `proactive.send` | `dispatch_outbox` | called by another service | dynamic | 1 | one effect per invocation; no loop reaches this send |
...
| `modules/automation/automation-jobs.processor.ts:328` | `handleSendTemplate` | `dispatch_outbox` | `modules/channels/outbound-queue.processor.ts` | si |

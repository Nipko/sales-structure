...
Recorrido de pago: [cómo agregar la tarjeta en Meta y separar seguridad, datos y cobros de Parallly](meta-card-setup-and-security-contract.md).

Protección de respuestas cobrables: [guardrails por destino y objetivo](whatsapp-response-spend-guardrails-plan.md), [Jelou/respond.io](competitor-jelou-respond-agent-controls.md), [otros referentes](competitor-agent-guardrails-evidence.md), [auditoría de emisores Parallly](parallly-conversation-abuse-code-audit.md), [escenarios de 47 mercados en USD/COP](whatsapp-response-cost-scenarios.json) y [directiva R0–R6 para Claude](../../handoffs/2026-09-10/claude-whatsapp-response-spend-guardrails.md).

...
export const FIRST_DETERMINISTIC_WORKFLOW_QUEUE: readonly DeterministicWorkflowDefinitionV1[] = Object.freeze([
    ...
    workflow({
        id: 'resource.rental', label: 'Resource rental', class: 'transactional', profilePattern: '*',
        triggerTools: Object.freeze(['create_vehicle_rental', 'create_pet_boarding']), requiredTools: Object.freeze(['check_vehicle_rental_availability', 'create_vehicle_rental', 'check_daycare_availability', 'create_pet_boarding']),
        ...
        requiredSlots: Object.freeze(['resource_id', 'start', 'end', 'contact']), validators: Object.freeze({ resource_id: 'active_resource', start: 'iso_date', end: 'half_open_after_start' }),
